 ...
 * @example
 * ```ts
 * const { result } = renderHookWithClient(() => useGoogleDriveFiles(), {
 *   client: queryClient,
 * });
 * ```
 *
 ...
 *
 * @param ui - The React element to render (e.g. <FilePickerGoogleDriveContainer />)
 ...
 * @example
 * ```ts
 * const { screen, queryClient } = renderWithProviders(<FilePickerGoogleDriveContainer />, {
